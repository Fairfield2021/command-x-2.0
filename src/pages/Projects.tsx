...
const Projects = () => {
  ...
  const handleEdit = (project: Project) => {
    ...
    setFormData({
      ...
      time_clock_enabled: (project as unknown as Record<string, unknown>).time_clock_enabled as boolean || false,
      require_clock_location: (project as unknown as Record<string, unknown>).require_clock_location as boolean ?? true,
