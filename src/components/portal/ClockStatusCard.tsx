...
export function ClockStatusCard({
    ...
    useLocationMonitor(
      activeEntry
        ? {
            ...
            clock_blocked_until:
              ((activeEntry as unknown as Record<string, unknown>).clock_blocked_until as string | null) ?? null,
          }
        : null,
      projectGeofence
        ? {
  ...
  const clockBlockedUntil = (activeEntry as unknown as Record<string, unknown>)?.clock_blocked_until as string | null;
  const isBlocked =
